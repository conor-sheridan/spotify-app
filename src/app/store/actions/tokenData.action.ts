...
export class RemoveTokenData implements Action {
    readonly type = REMOVE_TOKEN_DATA;
}

export type TokenDataActionTypes = AddTokenData | GetTokenData | RemoveTokenData;